...
- 🌱 I currently work with React.js (Next.js / Angular), Node.js (Express.js), Javascript, Typescript, TailwindCSS, Bootstrap, Python (Django), PHP (Laravel / CodeIgniter) and DB (MySQL, PostgreSQL, MongoDB).
- 📚 I am a student of the Systems Analysis and Development Course, 4nd semester, at Estácio de Sá institution.
